...
class DiffusionModel:
    ...
    def setup(self, stage):
        ...
        train_set, valid_set = datasets.get_train_data(self.config)
    ...
    def train(self):
        training_loss = []
        optimizer = self.configure_optimizers(self)
        train_dataloader, valid_dataloader = self.setup()
        self.model.train()
    ...
    def validation_epoch_end(self, outputs):
        ...
        # sample
        shape = (16, 1, self.config.dataset.resolution, self.config.dataset.resolution)
