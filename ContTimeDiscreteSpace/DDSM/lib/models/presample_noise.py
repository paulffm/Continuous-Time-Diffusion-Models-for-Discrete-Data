...
def main():
    ...
    filename = f'steps{cfg.num_time_steps}.cat{cfg.num_cat}{str_speed}.time{cfg.max_time}.' \
    ...
    v_one, v_zero, v_one_loggrad, v_zero_loggrad, timepoints = noise_factory(cfg.num_samples,
                                                                             cfg.num_time_steps,
                                                                             alpha,
                                                                             beta,
